...
public class EntityFish extends Entity
{
    ...
    public void onUpdate()
    {
        ...
        if(d5 > 0.0D)
        {
            ...
            {
                char c = '\u01F4';
                if(worldObj.func_27167_r(MathHelper.floor_double(posX), MathHelper.floor_double(posY) + 1, MathHelper.floor_double(posZ)))
                {
                    c = '\u012C';
                }
                if(rand.nextInt(c) == 0)
    ...
    public int catchFish()
    {
        ...
        if(field_4088_k > 0)
        {
            ...
            angler.addStat(StatList.field_25160_x, 1);
            byte0 = 1;
        }
        if(field_4091_h)
        {
