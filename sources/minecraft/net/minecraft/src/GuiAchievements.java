...
public class GuiAchievements extends GuiScreen
{
    ...
    {
        controlList.clear();
        controlList.add(new GuiSmallButton(1, width / 2 + 24, height / 2 + 74, 80, 20, StatCollector.func_25200_a("gui.done")));
    }
        ...
        if(Mouse.isButtonDown(0))
        {
            ...
            if((field_27122_w == 0 || field_27122_w == 1) && i >= i1 && i < i1 + 224 && j >= j1 && j < j1 + 155)
            {
                ...
                } else
                {
                    ...
                    field_27112_q = field_27114_o;
                    field_27111_r = field_27113_p;
                }
                field_27118_j = i;
                field_27117_l = j;
            }
    ...
    protected void func_27109_b(int i, int j, float f)
    {
        ...
        for(int l3 = 0; l3 < AchievementList.field_27388_e.size(); l3++)
        {
            ...
            renderitem.renderItemIntoGUI(mc.fontRenderer, mc.renderEngine, achievement3.field_27097_d, i6 + 3, k6 + 3);
            GL11.glDisable(2896 /*GL_LIGHTING*/);
            if(!field_27120_x.func_27181_b(achievement3))
            {
        ...
        if(achievement != null)
        {
            ...
            String s = achievement2.field_25070_e;
            ...
            if(field_27120_x.func_27181_b(achievement2))
            {
                ...
                if(field_27120_x.func_27183_a(achievement2))
                {
                    fontRenderer.drawStringWithShadow(StatCollector.func_25200_a("achievement.taken"), k5, j6 + j7 + 4, 0xff9090ff);
                }
            } else
            {
                int i7 = Math.max(fontRenderer.getStringWidth(s), 120);
                String s2 = StatCollector.func_25199_a("achievement.requires", new Object[] {
                    achievement2.field_25076_c.field_25070_e
                });
            ...
            fontRenderer.drawStringWithShadow(s, k5, j6, field_27120_x.func_27181_b(achievement2) ? achievement2.func_27093_f() ? -128 : -1 : achievement2.func_27093_f() ? 0xff808040 : 0xff808080);
        }
        GL11.glEnable(2929 /*GL_DEPTH_TEST*/);
    }
