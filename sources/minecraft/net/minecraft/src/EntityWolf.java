...
public class EntityWolf extends EntityAnimal
{
    ...
    protected String getLivingSound()
    {
        ...
        if(rand.nextInt(3) == 0)
        {
            if(isWolfTamed() && dataWatcher.func_25115_b(18) < 10)
            {
    ...
    public void onLivingUpdate()
    {
        ...
        if(!field_9343_G && field_25053_f && !field_25052_g && !hasPath() && onGround)
        {
            field_25052_g = true;
    ...
    public void onUpdate()
    {
        ...
        if((field_25053_f || field_25052_g) && field_25052_g)
        {
            ...
            field_25050_i = timeWolfIsShaking;
    ...
    {
        return 0.75F + ((field_25050_i + (timeWolfIsShaking - field_25050_i) * f) / 2.0F) * 0.25F;
    }

    public float func_25042_a(float f, float f1)
    {
        float f2 = (field_25050_i + (timeWolfIsShaking - field_25050_i) * f + f1) / 1.8F;
        if(f2 < 0.0F)
        {
            f2 = 0.0F;
        } else
    ...
    public boolean attackEntityFrom(Entity entity, int i)
    {
        ...
        if(super.attackEntityFrom(entity, i))
        {
            ...
            {
                if(isWolfTamed() && (entity instanceof EntityPlayer) && ((EntityPlayer)entity).username.equals(getWolfOwner()))
                {
                    return true;
                }
                playerToAttack = entity;
    ...
    public boolean interact(EntityPlayer entityplayer)
    {
        ...
        } else
        {
            if(itemstack != null && (Item.itemsList[itemstack.itemID] instanceof ItemFood))
            {
                ...
                if(itemfood.getIsWolfsFavoriteMeat() && dataWatcher.func_25115_b(18) < 20)
                {
                    itemstack.stackSize--;
                    if(itemstack.stackSize <= 0)
                    {
            ...
            if(entityplayer.username.equals(getWolfOwner()))
            {
                if(!worldObj.multiplayerWorld)
                {
