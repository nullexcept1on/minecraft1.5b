...
public class EntityPlayerSP extends EntityPlayer
{
    ...
    {
        if(!mc.field_25001_G.func_27183_a(AchievementList.field_25195_b))
        {
            mc.field_25002_t.func_27101_b(AchievementList.field_25195_b);
        }
    ...
    public void addStat(StatBase statbase, int i)
    {
        ...
        if(statbase.func_25067_a())
        {
            ...
            if(achievement.field_25076_c == null || mc.field_25001_G.func_27183_a(achievement.field_25076_c))
            {
                if(!mc.field_25001_G.func_27183_a(achievement))
                {
                    mc.field_25002_t.func_27102_a(achievement);
                }
                mc.field_25001_G.func_25100_a(statbase, i);
            }
        } else
        {
            mc.field_25001_G.func_25100_a(statbase, i);
