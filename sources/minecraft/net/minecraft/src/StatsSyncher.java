...
public class StatsSyncher
{
    ...
    public StatsSyncher(Session session, StatFileWriter statfilewriter, File file)
    {
        ...
        field_27427_l = 0;
        field_27426_m = 0;
        field_27434_e = new File(file, (new StringBuilder()).append("stats_").append(session.username).append("_unsent.dat").toString());
        field_27433_f = new File(file, (new StringBuilder()).append("stats_").append(session.username).append(".dat").toString());
        field_27430_i = new File(file, (new StringBuilder()).append("stats_").append(session.username).append("_unsent.old").toString());
        field_27429_j = new File(file, (new StringBuilder()).append("stats_").append(session.username).append(".old").toString());
        field_27432_g = new File(file, (new StringBuilder()).append("stats_").append(session.username).append("_unsent.tmp").toString());
        field_27431_h = new File(file, (new StringBuilder()).append("stats_").append(session.username).append(".tmp").toString());
