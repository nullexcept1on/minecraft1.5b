...
public class BlockRail extends Block
{
    ...
    public static final boolean func_27040_h(World world, int i, int j, int k)
    {
        ...
        return l == Block.minecartTrack.blockID || l == Block.field_9261_T.blockID || l == Block.field_9260_U.blockID;
    }

    public static final boolean func_27041_c(int i)
    {
        return i == Block.minecartTrack.blockID || i == Block.field_9261_T.blockID || i == Block.field_9260_U.blockID;
    }
    ...
    public int getBlockTextureFromSideAndMetadata(int i, int j)
    {
        if(field_27045_a)
        {
            if(blockID == Block.field_9261_T.blockID && (j & 8) == 0)
            {
    ...
    public void onNeighborBlockChange(World world, int i, int j, int k, int l)
    {
        ...
        if(blockID == Block.field_9261_T.blockID)
        {
        ...
        if(l > 0 && Block.blocksList[l].canProvidePower() && !field_27045_a && RailLogic.getNAdjacentTracks(new RailLogic(this, world, i, j, k)) == 3)
        {
            func_4031_h(world, i, j, k);
        }
    }
    ...
    private void func_4031_h(World world, int i, int j, int k)
    {
        ...
        {
            (new RailLogic(this, world, i, j, k)).func_792_a(world.isBlockIndirectlyGettingPowered(i, j, k));
            return;
        }
    }
    ...
    private boolean func_27043_a(World world, int i, int j, int k, boolean flag, int l, int i1)
    {
        ...
        if(j1 == Block.field_9261_T.blockID)
        {
